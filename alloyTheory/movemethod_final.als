...
run show for 2 Package, 3 Class,1 Field, 3 Method, 6 Id, 3 Body, 0 FieldInvocation, 0 ConstructorFieldInvocation 

one sig A extends ClassId {}
one sig M extends MethodId {}

fact MoveMethod {   
  oneOverloadingDirectlyHierarchy[Int_,Long_] || someOverridingDirectlyHierarchy[]
  someCaller[]
  #Package = 2
