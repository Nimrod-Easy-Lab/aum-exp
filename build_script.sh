...
mvn install:install-file -Dfile=lib/plume.jar -DgroupId=plume -DartifactId=plume -Dversion=1.0 -Dpackaging=jar
...
#Install in the user local repository
mvn install:install-file -Dfile=lib/nimrod.jar -DgroupId=nimrod -DartifactId=nimrod -Dversion=1.0 -Dpackaging=jar
